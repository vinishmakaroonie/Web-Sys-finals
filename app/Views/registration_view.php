...
<div class="d-flex align-items-center justify-content-center register-container">
    <div class="col col-md-6 form-wrapper">
        ...
        <form action="<?= base_url('users/add'); ?>" method="post" class="login-form">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success login-button">Sign Up</button>
                <a href="<?= base_url('login'); ?>" class="btn btn-danger">Cancel</a>
            </div>
        </form>
    </div>
</div>
